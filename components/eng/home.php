<section class="section home">
  ...
  <div class="home__grid">
    ...
    <nav class="home__menu">
      <a class="home__menu__link" <?php echo 'href="store.php?language=' . $language . '"'; ?>>STORE</a>
      <a class="home__menu__link" <?php echo 'href="videos.php?language=' . $language . '"'; ?>>VIDEOS</a>
      <a class="home__menu__link" <?php echo 'href="music.php?language=' . $language . '"'; ?>>MUSIC</a>
      <a class="home__menu__link" <?php echo 'href="shows.php?language=' . $language . '"'; ?>>SHOWS</a>
      <a class="home__menu__link" <?php echo 'href="about.php?language=' . $language . '"'; ?>>ABOUT</a>
      <a class="home__menu__link" <?php echo 'href="contact.php?language=' . $language . '"'; ?>">CONTACT</a>  
    </nav>
