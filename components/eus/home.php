<section class="section home">
  ...
  <div class="home__grid">
    ...
    <nav class="home__menu">
      <a class="home__menu__link" <?php echo 'href="store.php?language=' . $language . '"'; ?>>DENDA</a>
      <a class="home__menu__link" <?php echo 'href="videos.php?language=' . $language . '"'; ?>>BIDEOAK</a>
      <a class="home__menu__link" <?php echo 'href="music.php?language=' . $language . '"'; ?>>MIUSIKA</a>
      <a class="home__menu__link" <?php echo 'href="shows.php?language=' . $language . '"'; ?>>KONTZERTUAK</a>
      <a class="home__menu__link" <?php echo 'href="about.php?language=' . $language . '"'; ?>>INFO</a>
      <a class="home__menu__link" <?php echo 'href="contact.php?language=' . $language . '"'; ?>">KONTAKTUA</a>  
    </nav>
