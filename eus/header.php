    ...
    <div class="header">
      <div class="header__grid">
        ...
        <nav class="header__menu" id="header__mymenu">
          ...
          <a class="header__menu__link active" href="store.php">DENDA</a>
          <a class="header__menu__link active" href="videos.php">BIDEOAK</a>
          <a class="header__menu__link active" href="music.php">MUSIKA</a>
          <a class="header__menu__link active" href="shows.php">SHOWS</a>
          <a class="header__menu__link active" href="about.php">INFO</a>
          <a class="header__menu__link active" href="contact.php">KONTAKTUA</a>  
        </nav>
      </div>
    </div>  
