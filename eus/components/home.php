<section class="section home">
  ...
  <div class="home__grid">
    ...
    <nav class="home__menu">
      <a class="home__menu__link" href="store.php">DENDA</a>
      <a class="home__menu__link" href="videos.php">BIDEOAK</a>
      <a class="home__menu__link" href="music.php">MUSIKA</a>
      <a class="home__menu__link" href="shows.php">KONTZERTUAK</a>
      <a class="home__menu__link" href="about.php">INFO</a>
